...
export default {
  ...
  methods: {
    ...
    getcanvas() {
      ...
      sessionStorage.setItem("signBase64", base64);
      this.updatavue();
    },
    //旋转图片
    convertImg(file) {
      ...
      oReader.onload = function(e) {
        ...
        img.onload = function() {
          ...
          sessionStorage.setItem("signBase64", _this.basedata);
          _this.updatavue();
        };
      };
      alert("旋转chu");
    ...
    async updatavue() {
      ...
      this.axios({
        ...
        .then(res => {
          sessionStorage.setItem("chargeSignFile", JSON.stringify(res.data[0]));
          this.show = false;
          this.$router.go(-1);
        })
        .catch(err => {
